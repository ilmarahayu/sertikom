<div class="modal-header">
    <h5 class="modal-title">Edit coffe</h5>
...
<form method="post" action="{{ route('admin.update_produk') }}" enctype="multipart/form-data">
    ...
    <div class="modal-body">
        ...
        <div class="form-group mt-3">
            ...
            <input type="text" class="form-control @error("nama_coffe") is-invalid @enderror" value="{{$edit->nama_coffe}}" name="nama_coffe" id="nama_coffe" placeholder="">
        </div>
